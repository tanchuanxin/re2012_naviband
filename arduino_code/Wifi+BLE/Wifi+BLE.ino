...
const char* ipv4_address = "192.168.1.20"; // IPv4 address obtained from cmd --> ipconfig
const char* host_name = "Host: 192.168.1.20"; // hostname for localhost
...
void loop() {
  ...
  for (int i = 0; i < deviceCount; i++) {
    ...
    if (device.haveName ()){
      ...
      String string1 = "Beacon01";
      String string2 = "Beacon02";
      String string3 = "Beacon03";
